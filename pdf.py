...
class App(QWidget):
    ...
    def openFileNameDialog(self):
        ...
        fileName, _ = QFileDialog.getOpenFileName(self,"Open", "","All Files (*);; Text (*.txt);; PDF (*.pdf);; Doc (*.docx)", options=options)
        if fileName:
            return fileName
    ...
    def openFileNamesDialog(self):
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        files, _ = QFileDialog.getOpenFileNames(self,"Open", "","All Files (*);; Text (*.txt);; PDF (*.pdf);; Doc (*.docx)", options=options)
        if files:
            return files
    ...
    def saveFileDialog(self):
        options = QFileDialog.Options()
        options |= QFileDialog.DontUseNativeDialog
        fileName, _ = QFileDialog.getSaveFileName(self,"Save as","","All Files (*);; Text (*.txt);; PDF (*.pdf);; Doc (*.docx)", options=options)
        if fileName:
            return fileName
